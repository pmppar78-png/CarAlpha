...
function authorityLinks(): string {
  ...
  <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-3">
    <a href="/guides/vin-decoding-guide/" class="glass-card metallic-border rounded-xl p-4 card-hover carbon-panel group"><div class="font-bold text-white text-sm group-hover:text-volt-400 transition-colors">VIN Decoding Guide</div><div class="text-[10px] text-silver-500 mt-1">Complete technical deep dive</div></a>
    ...
    <a href="/contact/" class="glass-card metallic-border rounded-xl p-4 card-hover carbon-panel group"><div class="font-bold text-white text-sm group-hover:text-volt-400 transition-colors">Contact Us</div><div class="text-[10px] text-silver-500 mt-1">Questions, corrections, partnerships</div></a>
  </div>
</div>`;
}
